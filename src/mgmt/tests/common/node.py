...
#        self.delete_container()
    ...
    def _start_aca_node(self):
        ...
        # Mount current working directory to /mnt/Arion
        mount_pnt = docker.types.Mount("/mnt/Arion",
                                       os.getcwd(),
                                       type='bind')
        ...
        self.run(
            "./mnt/Arion/src/extern/alcor-control-agent/build/bin/AlcorControlAgent", detach=True)
